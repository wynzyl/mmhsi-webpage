      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-white/[0.04]">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[10px] tracking-[0.3em] uppercase text-[#D4A853] font-sans">Campus</span>
          </div>
          ...
          <p className="font-display text-xl italic text-[#F5F0E8]/45 font-light">
            World-class infrastructure supporting excellence in education
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-start gap-6 mb-16">
            ...
            <div>
              <p className="text-[10px] text-[#D4A853] tracking-[0.3em] uppercase font-sans mb-2">Infrastructure</p>
      ...
      <section className="bg-[#121212] py-24 px-4 sm:px-6 lg:px-8 border-t border-white/[0.04]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-start gap-6 mb-16">
            ...
            <div>
              <p className="text-[10px] text-[#D4A853] tracking-[0.3em] uppercase font-sans mb-2">Campus Life</p>
              <h2 className="font-display text-4xl md:text-5xl font-semibold text-[#F5F0E8] leading-tight">
                Campus Highlights
              </h2>
            </div>
